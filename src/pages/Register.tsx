...
export default function Register() {
  const { loginWithGoogle, registerWithEmail, error, clearError, user } = useAuth();
  ...
  return (
    <div className="pt-32 pb-20 px-4 flex flex-col items-center justify-center min-h-[80vh]">
      ...
      >
        ...
        <h1 className="text-2xl font-bold uppercase tracking-widest text-center mb-2">Join AURA</h1>
        <p className="text-gray-400 text-xs uppercase tracking-wider text-center mb-10 font-light">
          Create your minimalist space
        </p>
